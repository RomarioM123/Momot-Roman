...
public:
	...
	friend istream& operator>> (istream&, CProgram&);			/** Оголошення перевантаженого оператора вводу*/
	...
	CProgram& operator= (CProgram&);							/** Оголошення перевантаженого оператора присвоювання*/
};
